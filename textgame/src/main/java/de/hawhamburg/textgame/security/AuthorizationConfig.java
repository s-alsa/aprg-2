        ...
        http.authorizeHttpRequests(authz -> authz
            ...
            .requestMatchers("/secure").authenticated()// This endpoint is available for any logged-in user (regardless of the role).
               ...
               // .requestMatchers("/wouldyourather.css").permitAll()
                .requestMatchers("/styles.css").permitAll() // This is not an endpoint but access to other resources must be set as well. You may also use the * for multiple files, e.g., *.css or /img/*.*
