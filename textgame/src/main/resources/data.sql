...
CREATE TABLE Questions (
                           question_id   LONG PRIMARY KEY AUTO_INCREMENT,
                           option1       VARCHAR(255) NOT NULL,
                           option2       VARCHAR(255) NOT NULL,
                           option1_id    VARCHAR,
                           option2_id    VARCHAR,
                           answer_count1 INT DEFAULT '0',
                           answer_count2 INT DEFAULT '0'
);
...
INSERT INTO Questions (option1, option2, option1_id, option2_id) VALUES
    ...
    ('live somewhere where the sun never shines',
     'where its always over 30°', '6a', '6b'),
    ...
    ('forget all the memories you have now',
     'never be able to remember anything new', '13a', '13b'),
    ('find out when youre going to die',
     'how youre going to die', '14a', '14b'),
    ('have a roommate who is nice but never cleans',
     'a roommate who is clean but not nice', '15a', '15b'),
    ('go blind',
     'lose the ability to speak', '16a', '16b'),
    ...
    ('be able to freeze time',
     'make yourself invisible', '19a', '19b'),
